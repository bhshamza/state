...
import Image from '../src/hamza.jpg';
...
class App extends Component {
    constructor(){
        super();
         this.state = {
     Show: false,
        FullName:"hamza benhsan",
        Bio:"I'm a full stack programmer, graphic designer and an architect  ",
        Profession:'Student at Go My Code and Epi',
